...
Source0: http://rubyforge.org/frs/download.php/45905/rubygems-1.3.6.tgz
Patch0: rubygems-1.3.6-noarch-gemdir.patch
...
rm -rf %{buildroot}/%{ruby_sitelib}/usr/bin
...
%changelog
* Tue Jun 15 2010 Sergio Rubio <rubiojr@frameos.org> - 1.3.6-1
